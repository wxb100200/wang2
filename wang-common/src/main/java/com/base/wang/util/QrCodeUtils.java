...
public class QrCodeUtils {
        ...
        for (int y = 0; y < matrix.getHeight(); y++) {
            for (int x = 0; x < matrix.getWidth(); x++) {
                ...
                if (x > 0 && x < 170 && y > 0 && y < 170) {
                    Color color = new Color(44, 151, 244);
    ...
    public static void main(String[] args){
        ...
        String logoPath = "D:/myProject/wang-base/logo.png";
        String localPath = "D:/myProject/wang-base/erweima.jpg";
        encode(content, 512, 512, logoPath, localPath );
    }
}
